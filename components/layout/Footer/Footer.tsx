...
export function Footer() {
  return (
    <footer
      id="contacto"
      className="bg-[#153c2d] px-5 py-10 text-white sm:px-8 lg:px-10"
    >
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 sm:flex-row">
        <p className="text-center text-sm text-white/74 sm:text-left">
          © 2026 AgroIndustrial Peru. Todos los derechos reservados.
        </p>
